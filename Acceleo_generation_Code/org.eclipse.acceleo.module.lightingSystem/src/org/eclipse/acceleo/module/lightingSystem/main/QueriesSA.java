...
public class QueriesSA {
	
    public Set<SystemComponent> allSysComponents = new HashSet<>();
	...
	public Set<SystemComponent> getAllSysComponents(Set<SystemComponent> components) {
		for(SystemComponent component : components) {
			...
			if(!component.getOwnedFunctionalAllocation().isEmpty()) {
				allSysComponents.add(component);
			}
			getAllSysComponents(component.getOwnedSystemComponents().stream().collect(Collectors.toSet()));
		}
		
		return allSysComponents;
	}
	
	public String fillSetsPart(SystemComponent component, Set<ComponentFunctionalAllocation> functions, SystemComponent lastcomponent) {
	...
	public void fillInitialisations(SystemComponent component) {
	...
	public String getEvents(SystemComponent component, String functionId, String functionName, String type, 
			                        Set<FunctionalExchange> exchanges) {
