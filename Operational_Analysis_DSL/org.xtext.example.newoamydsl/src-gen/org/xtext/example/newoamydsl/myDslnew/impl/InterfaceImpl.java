 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getSid <em>Sid</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getVisibleInDoc <em>Visible In Doc</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getVisibleInLM <em>Visible In LM</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getReview <em>Review</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getMechanism <em>Mechanism</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getStructural <em>Structural</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getAppliedPropertyValues <em>Applied Property Values</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getAppliedPropertyValueGroups <em>Applied Property Value Groups</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedPropertyValues <em>Owned Property Values</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedEnumerationPropertyTypes <em>Owned Enumeration Property Types</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedPropertyValueGroups <em>Owned Property Value Groups</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedTraces <em>Owned Traces</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedGeneralizations <em>Owned Generalizations</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedFeatures <em>Owned Features</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getNestedGeneralClasses <em>Nested General Classes</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedInterfaceAllocations <em>Owned Interface Allocations</em>}</li>
 *   <li>{@link org.xtext.example.newoamydsl.myDslnew.impl.InterfaceImpl#getOwnedExchangeItemAllocations <em>Owned Exchange Item Allocations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface
{
  ...
  {
    return MyDslnewPackage.eINSTANCE.getInterface();
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__TYPE, oldType, type));
  }
  ...
  public void setId(String newId)
  {
    ...
    id = newId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__ID, oldId, id));
  }
  ...
  public void setSid(String newSid)
  {
    ...
    sid = newSid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__SID, oldSid, sid));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__NAME, oldName, name));
  }
  ...
  public void setVisibleInDoc(String newVisibleInDoc)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__VISIBLE_IN_DOC, oldVisibleInDoc, visibleInDoc));
  }
  ...
  public void setVisibleInLM(String newVisibleInLM)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__VISIBLE_IN_LM, oldVisibleInLM, visibleInLM));
  }
  ...
  public void setSummary(String newSummary)
  {
    ...
    summary = newSummary;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__SUMMARY, oldSummary, summary));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__DESCRIPTION, oldDescription, description));
  }
  ...
  public void setReview(String newReview)
  {
    ...
    review = newReview;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__REVIEW, oldReview, review));
  }
  ...
  public void setVisibility(VisibilityKind newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setMechanism(String newMechanism)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__MECHANISM, oldMechanism, mechanism));
  }
  ...
  public void setStructural(String newStructural)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__STRUCTURAL, oldStructural, structural));
  }
  ...
  public void setAppliedPropertyValues(String newAppliedPropertyValues)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__APPLIED_PROPERTY_VALUES, oldAppliedPropertyValues, appliedPropertyValues));
  }
  ...
  public void setAppliedPropertyValueGroups(String newAppliedPropertyValueGroups)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__APPLIED_PROPERTY_VALUE_GROUPS, oldAppliedPropertyValueGroups, appliedPropertyValueGroups));
  }
  ...
  public void setStatus(String newStatus)
  {
    ...
    status = newStatus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__STATUS, oldStatus, status));
  }
  ...
  public void setFeatures(String newFeatures)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__FEATURES, oldFeatures, features));
  }
  ...
  public void setAbstract(String newAbstract)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__ABSTRACT, oldAbstract, abstract_));
  }
  ...
  public void setFinal(String newFinal)
  {
    ...
    final_ = newFinal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslnewPackage.INTERFACE__FINAL, oldFinal, final_));
  }
  ...
  public EList<AbstractPropertyValue> getOwnedPropertyValues()
  {
    ...
    {
      ownedPropertyValues = new EObjectContainmentEList<AbstractPropertyValue>(AbstractPropertyValue.class, this, MyDslnewPackage.INTERFACE__OWNED_PROPERTY_VALUES);
    }
  ...
  public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes()
  {
    ...
    {
      ownedEnumerationPropertyTypes = new EObjectContainmentEList<EnumerationPropertyType>(EnumerationPropertyType.class, this, MyDslnewPackage.INTERFACE__OWNED_ENUMERATION_PROPERTY_TYPES);
    }
  ...
  public EList<PropertyValueGroup> getOwnedPropertyValueGroups()
  {
    ...
    {
      ownedPropertyValueGroups = new EObjectContainmentEList<PropertyValueGroup>(PropertyValueGroup.class, this, MyDslnewPackage.INTERFACE__OWNED_PROPERTY_VALUE_GROUPS);
    }
  ...
  public EList<Trace> getOwnedTraces()
  {
    if (ownedTraces == null)
    {
      ownedTraces = new EObjectContainmentEList<Trace>(Trace.class, this, MyDslnewPackage.INTERFACE__OWNED_TRACES);
    }
    return ownedTraces;
  }
  ...
  public EList<Generalization> getOwnedGeneralizations()
  {
    ...
    {
      ownedGeneralizations = new EObjectContainmentEList<Generalization>(Generalization.class, this, MyDslnewPackage.INTERFACE__OWNED_GENERALIZATIONS);
    }
  ...
  public EList<Feature> getOwnedFeatures()
  {
    ...
    {
      ownedFeatures = new EObjectContainmentEList<Feature>(Feature.class, this, MyDslnewPackage.INTERFACE__OWNED_FEATURES);
    }
  ...
  public EList<GeneralClass> getNestedGeneralClasses()
  {
    ...
    {
      nestedGeneralClasses = new EObjectContainmentEList<GeneralClass>(GeneralClass.class, this, MyDslnewPackage.INTERFACE__NESTED_GENERAL_CLASSES);
    }
  ...
  public EList<InterfaceAllocation> getOwnedInterfaceAllocations()
  {
    ...
    {
      ownedInterfaceAllocations = new EObjectContainmentEList<InterfaceAllocation>(InterfaceAllocation.class, this, MyDslnewPackage.INTERFACE__OWNED_INTERFACE_ALLOCATIONS);
    }
  ...
  public EList<ExchangeItemAllocation> getOwnedExchangeItemAllocations()
  {
    ...
    {
      ownedExchangeItemAllocations = new EObjectContainmentEList<ExchangeItemAllocation>(ExchangeItemAllocation.class, this, MyDslnewPackage.INTERFACE__OWNED_EXCHANGE_ITEM_ALLOCATIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslnewPackage.INTERFACE__OWNED_PROPERTY_VALUES:
        return ((InternalEList<?>)getOwnedPropertyValues()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__OWNED_ENUMERATION_PROPERTY_TYPES:
        return ((InternalEList<?>)getOwnedEnumerationPropertyTypes()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__OWNED_PROPERTY_VALUE_GROUPS:
        return ((InternalEList<?>)getOwnedPropertyValueGroups()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__OWNED_TRACES:
        return ((InternalEList<?>)getOwnedTraces()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__OWNED_GENERALIZATIONS:
        return ((InternalEList<?>)getOwnedGeneralizations()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__OWNED_FEATURES:
        return ((InternalEList<?>)getOwnedFeatures()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__NESTED_GENERAL_CLASSES:
        return ((InternalEList<?>)getNestedGeneralClasses()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__OWNED_INTERFACE_ALLOCATIONS:
        return ((InternalEList<?>)getOwnedInterfaceAllocations()).basicRemove(otherEnd, msgs);
      case MyDslnewPackage.INTERFACE__OWNED_EXCHANGE_ITEM_ALLOCATIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslnewPackage.INTERFACE__TYPE:
        return getType();
      case MyDslnewPackage.INTERFACE__ID:
        return getId();
      case MyDslnewPackage.INTERFACE__SID:
        return getSid();
      case MyDslnewPackage.INTERFACE__NAME:
        return getName();
      case MyDslnewPackage.INTERFACE__VISIBLE_IN_DOC:
        return getVisibleInDoc();
      case MyDslnewPackage.INTERFACE__VISIBLE_IN_LM:
        return getVisibleInLM();
      case MyDslnewPackage.INTERFACE__SUMMARY:
        return getSummary();
      case MyDslnewPackage.INTERFACE__DESCRIPTION:
        return getDescription();
      case MyDslnewPackage.INTERFACE__REVIEW:
        return getReview();
      case MyDslnewPackage.INTERFACE__VISIBILITY:
        return getVisibility();
      case MyDslnewPackage.INTERFACE__MECHANISM:
        return getMechanism();
      case MyDslnewPackage.INTERFACE__STRUCTURAL:
        return getStructural();
      case MyDslnewPackage.INTERFACE__APPLIED_PROPERTY_VALUES:
        return getAppliedPropertyValues();
      case MyDslnewPackage.INTERFACE__APPLIED_PROPERTY_VALUE_GROUPS:
        return getAppliedPropertyValueGroups();
      case MyDslnewPackage.INTERFACE__STATUS:
        return getStatus();
      case MyDslnewPackage.INTERFACE__FEATURES:
        return getFeatures();
      case MyDslnewPackage.INTERFACE__ABSTRACT:
        return getAbstract();
      case MyDslnewPackage.INTERFACE__FINAL:
        return getFinal();
      case MyDslnewPackage.INTERFACE__OWNED_PROPERTY_VALUES:
