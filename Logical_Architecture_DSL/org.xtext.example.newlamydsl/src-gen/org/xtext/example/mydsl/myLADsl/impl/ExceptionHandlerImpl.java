 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myLADsl.impl.ExceptionHandlerImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myLADsl.impl.ExceptionHandlerImpl#getHandlerBody <em>Handler Body</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myLADsl.impl.ExceptionHandlerImpl#getExceptionInput <em>Exception Input</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myLADsl.impl.ExceptionHandlerImpl#getExceptionTypes <em>Exception Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExceptionHandlerImpl extends MinimalEObjectImpl.Container implements ExceptionHandler
{
  ...
  {
    return MyLADslPackage.eINSTANCE.getExceptionHandler();
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyLADslPackage.EXCEPTION_HANDLER__TYPE, oldType, type));
  }
  ...
  public void setHandlerBody(String newHandlerBody)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyLADslPackage.EXCEPTION_HANDLER__HANDLER_BODY, oldHandlerBody, handlerBody));
  }
  ...
  public void setExceptionInput(String newExceptionInput)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyLADslPackage.EXCEPTION_HANDLER__EXCEPTION_INPUT, oldExceptionInput, exceptionInput));
  }
  ...
  public void setExceptionTypes(String newExceptionTypes)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyLADslPackage.EXCEPTION_HANDLER__EXCEPTION_TYPES, oldExceptionTypes, exceptionTypes));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyLADslPackage.EXCEPTION_HANDLER__TYPE:
        return getType();
      case MyLADslPackage.EXCEPTION_HANDLER__HANDLER_BODY:
        return getHandlerBody();
      case MyLADslPackage.EXCEPTION_HANDLER__EXCEPTION_INPUT:
        return getExceptionInput();
      case MyLADslPackage.EXCEPTION_HANDLER__EXCEPTION_TYPES:
